...
public class Img_ZoomInOut extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getPhoto() {
        ...
        Picasso.get().load(this.g.mainUrl+"/voting/upload/photo/"+this.url).resize(this.g.w(360), 0).placeholder(R.drawable.photo_holder).error(R.mipmap.ic_launcher).into(img, new Callback() {
            @Override
