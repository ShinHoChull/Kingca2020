...
import com.m2comm.kingca2020.databinding.ActivityPhotoBinding;
...
import com.m2comm.kingca2020.modules.common.PermissionRequester;
import com.m2comm.kingca2020.views.Img_ZoomInOut;
...
public class PhotoViewModel implements View.OnClickListener {
    ...
    public PhotoViewModel(ActivityPhotoBinding activity, Context c, Activity a) {
    ...
    private void init() {
        ...
        this.strUrl = "39";
        //this.getPhotoUrl("39");
        this.activity.photoSelectBt1.setBackgroundColor(this.c.getResources().getColor(R.color.main_color_blue));
...
//                    tempArr.remove(0);
                 //   r = this.urlList.get(i);
                    ...
                    Picasso.get().load(this.g.mainUrl + "/voting/upload/photo/" + r.getUrl()).
                            resize(w * 2, h * 2).placeholder(R.drawable.photo_holder).error(R.mipmap.ic_launcher).into(iv2);
              //  }
            } else {
                //r = this.urlList.get(i);
                params.width = w;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.photo_select_bt1:
                ...
                tv1.setBackgroundColor(this.c.getResources().getColor(R.color.main_color_blue));
                this.strUrl = "39";
                this.getPhotoUrl("39");
                break;
            ...
            case R.id.photo_select_bt2:
                ...
                tv2.setBackgroundColor(this.c.getResources().getColor(R.color.main_color_blue));
                this.strUrl = "40";
                this.getPhotoUrl("40");
                break;
            ...
            case R.id.photo_select_bt3:
                ...
                tv3.setBackgroundColor(this.c.getResources().getColor(R.color.main_color_blue));
                this.strUrl = "41";
                this.getPhotoUrl("41");
                break;
            ...
            case R.id.photo_select_bt5:
                ...
                tv4.setBackgroundColor(this.c.getResources().getColor(R.color.main_color_blue));
                this.strUrl = "-2";
                this.getPhotoUrl("-2");
                break;
            ...
            case R.id.photo_select_bt4:
                ...
                tv5.setBackgroundColor(this.c.getResources().getColor(R.color.main_color_blue));
                this.strUrl = "-1";
                this.getPhotoUrl("-1");
    ...
    private File savePictureFile() {
        ...
        if (result == PermissionRequester.ALREADY_GRANTED || result == PermissionRequester.REQUEST_PERMISSION) {
            ...
            try {
                File file = File.createTempFile("kingca2019_", ".png", pictureStorage);
